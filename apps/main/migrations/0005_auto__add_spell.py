...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Spell'
        db.create_table('main_spell', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hero', self.gf('django.db.models.fields.related.ForeignKey')(related_name='spells', to=orm['main.Hero'])),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('cnt', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('main', ['Spell'])


    def backwards(self, orm):
        # Deleting model 'Spell'
        db.delete_table('main_spell')
