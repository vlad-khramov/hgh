...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HeroLog'
        db.create_table('main_herolog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hero', self.gf('django.db.models.fields.related.ForeignKey')(related_name='log', to=orm['main.Hero'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('main', ['HeroLog'])


    def backwards(self, orm):
        # Deleting model 'HeroLog'
        db.delete_table('main_herolog')
    ...
    models = {
        ...
        'main.event': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'github_events'", 'to': "orm['auth.User']"})
        },
        'main.hero': {
        ...
        'main.herolog': {
            'Meta': {'object_name': 'HeroLog'},
            'date': ('django.db.models.fields.DateTimeField', [], {}),
            'hero': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'log'", 'to': "orm['main.Hero']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
