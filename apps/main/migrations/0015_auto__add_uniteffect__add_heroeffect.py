...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UnitEffect'
        db.create_table('main_uniteffect', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='active_effects', to=orm['main.Unit'])),
            ...
            ('param', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('main', ['UnitEffect'])

        # Adding model 'HeroEffect'
        db.create_table('main_heroeffect', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hero', self.gf('django.db.models.fields.related.ForeignKey')(related_name='active_effects', to=orm['main.Hero'])),
            ('duration', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('param', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('main', ['HeroEffect'])


    def backwards(self, orm):
        # Deleting model 'UnitEffect'
        db.delete_table('main_uniteffect')

        # Deleting model 'HeroEffect'
        db.delete_table('main_heroeffect')
