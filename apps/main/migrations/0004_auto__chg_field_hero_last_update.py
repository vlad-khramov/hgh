...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hero.last_update'
        db.alter_column('main_hero', 'last_update', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Hero.last_update'
        db.alter_column('main_hero', 'last_update', self.gf('django.db.models.fields.CharField')(max_length=100))
