...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Battle'
        db.create_table('main_battle', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hero1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='battles1', to=orm['main.Hero'])),
            ('hero2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='battles2', to=orm['main.Hero'])),
            ('hero1_moved', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('hero2_moved', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('round', self.gf('django.db.models.fields.SmallIntegerField')(default=1)),
            ('winner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='winned_battles', to=orm['main.Hero'])),
        ))
        db.send_create_signal('main', ['Battle'])


    def backwards(self, orm):
        # Deleting model 'Battle'
        db.delete_table('main_battle')
    ...
    models = {
        ...
        'main.battle': {
            ...
            'winner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'winned_battles'", 'to': "orm['main.Hero']"})
        },
        'main.battlequeue': {
