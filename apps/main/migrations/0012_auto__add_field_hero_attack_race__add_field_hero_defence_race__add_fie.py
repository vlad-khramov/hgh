...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hero.attack_race'
        db.add_column('main_hero', 'attack_race',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.defence_race'
        db.add_column('main_hero', 'defence_race',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.attentiveness_race'
        db.add_column('main_hero', 'attentiveness_race',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Hero.charm_race'
        db.add_column('main_hero', 'charm_race',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hero.attack_race'
        db.delete_column('main_hero', 'attack_race')

        # Deleting field 'Hero.defence_race'
        db.delete_column('main_hero', 'defence_race')

        # Deleting field 'Hero.attentiveness_race'
        db.delete_column('main_hero', 'attentiveness_race')

        # Deleting field 'Hero.charm_race'
        db.delete_column('main_hero', 'charm_race')
