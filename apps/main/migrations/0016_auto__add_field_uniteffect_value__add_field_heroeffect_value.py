...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UnitEffect.value'
        db.add_column('main_uniteffect', 'value',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'HeroEffect.value'
        db.add_column('main_heroeffect', 'value',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UnitEffect.value'
        db.delete_column('main_uniteffect', 'value')

        # Deleting field 'HeroEffect.value'
        db.delete_column('main_heroeffect', 'value')
