...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Battle.winner'
        db.alter_column('main_battle', 'winner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['main.Hero']))

    def backwards(self, orm):

        # Changing field 'Battle.winner'
        db.alter_column('main_battle', 'winner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main.Hero']))
