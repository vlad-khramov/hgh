...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CastingSpell.target_unit'
        db.alter_column('main_castingspell', 'target_unit_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['main.Unit']))

        # Changing field 'CastingSpell.target_hero'
        db.alter_column('main_castingspell', 'target_hero_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['main.Hero']))

    def backwards(self, orm):

        # Changing field 'CastingSpell.target_unit'
        db.alter_column('main_castingspell', 'target_unit_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main.Unit']))

        # Changing field 'CastingSpell.target_hero'
        db.alter_column('main_castingspell', 'target_hero_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main.Hero']))
    ...
    models = {
        ...
        'main.castingspell': {
            'Meta': {'object_name': 'CastingSpell'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'spell': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'casts_in_process'", 'to': "orm['main.Spell']"}),
            'target_hero': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'target_of_spells'", 'null': 'True', 'to': "orm['main.Hero']"}),
            'target_param': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'target_unit': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'target_of_spells'", 'null': 'True', 'to': "orm['main.Unit']"})
        },
        'main.hero': {
        ...
        'main.heroeffect': {
            'Meta': {'object_name': 'HeroEffect'},
            'duration': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'hero': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'active_effects'", 'to': "orm['main.Hero']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'param': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        'main.uniteffect': {
            'Meta': {'object_name': 'UnitEffect'},
            'duration': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'param': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'active_effects'", 'to': "orm['main.Unit']"}),
            'value': ('django.db.models.fields.IntegerField', [], {'default': '1'})
        }
    }
