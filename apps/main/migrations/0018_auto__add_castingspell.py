...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CastingSpell'
        db.create_table('main_castingspell', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('spell', self.gf('django.db.models.fields.related.ForeignKey')(related_name='casts_in_process', to=orm['main.Spell'])),
            ('target_unit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='target_of_spells', to=orm['main.Unit'])),
            ('target_hero', self.gf('django.db.models.fields.related.ForeignKey')(related_name='target_of_spells', to=orm['main.Hero'])),
            ('target_param', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('main', ['CastingSpell'])


    def backwards(self, orm):
        # Deleting model 'CastingSpell'
        db.delete_table('main_castingspell')
    ...
    models = {
        ...
        'main.castingspell': {
            ...
            'target_hero': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'target_of_spells'", 'to': "orm['main.Hero']"}),
            'target_param': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'target_unit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'target_of_spells'", 'to': "orm['main.Unit']"})
        },
        'main.hero': {
