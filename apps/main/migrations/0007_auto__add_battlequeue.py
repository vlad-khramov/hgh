...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BattleQueue'
        db.create_table('main_battlequeue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hero', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Hero'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('main', ['BattleQueue'])


    def backwards(self, orm):
        # Deleting model 'BattleQueue'
        db.delete_table('main_battlequeue')
