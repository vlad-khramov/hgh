...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_unit', 'battle_target',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main.Unit'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Unit.battle_target'
        db.delete_column('main_unit', 'battle_target_id')
